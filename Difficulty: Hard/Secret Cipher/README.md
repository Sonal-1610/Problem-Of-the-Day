<h2><a href="https://www.geeksforgeeks.org/problems/secret-cipher--141631/1?_gl=1*10t5hh7*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwhZDUBhBGEiwAbi5bjiYdse-AUExi2sW-MrM9wU_NnK12zoaxaUU1y7Aikyx-t_ZU3mbqWxoCLCcQAvD_BwE&gbraid=0AAAAAC9yBkAkpGtHaw0H5wEWw6uDR60fb">Secret Cipher</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p class="PDq2pG_selectionAnchorContainer" data-start="23" data-end="177"><span style="font-size: 14pt;">Geek wants to send a secret message to his friend Keeg. Instead of sending the original message directly, he encrypts it by inserting the character '*'.</span></p>
